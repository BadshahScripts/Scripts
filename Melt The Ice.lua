-- =================================================================
-- CONFIGURATION: Melt The Ice Script (Badshah Mobile UI)
-- =================================================================
local GameName = "Melt The Ice"
...
local Features = {
    {
        ...
        Callback = function(state)
            _G.AutoFuelActive = state
            print("[Melt The Ice] Auto Fuel set to:", state)
        end
    },
    {
        Type = "Toggle",
        ...
        Callback = function(state)
            ...
            print("[Melt The Ice] Auto Upgrade set to:", state)
        end
    },
    {
        Type = "Toggle",
        ...
        Callback = function(state)
            ...
            print("[Melt The Ice] Auto Collect set to:", state)
        end
    },
    {
        Type = "Slider",
...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        ...
        Text = "Melt The Ice Script Loaded Successfully!",
        Duration = 5
    })
end)
...
-- =================================================================
-- BACKGROUND REMOTE DISPATCHER (NO SCREEN/INPUT HIJACK)
-- =================================================================
...
-- =================================================================
-- 1. AUTO FUEL LOOP (BACKGROUND REMOTE + DIRECT VALUES LOCK)
-- =================================================================
task.spawn(function()
    while true do
        task.wait(0.15)
        if _G.AutoFuelActive then
            pcall(function()
                local char = LocalPlayer.Character

                -- 1. Scan and refill fuel ValueObjects & Attributes
                ...
                -- 2. Fire Refill Remotes in Background
                fireGameRemotes(
...
-- =================================================================
-- 2. AUTO UPGRADE LOOP (PURE SERVER-SIDE REMOTE DISPATCHER - NO POPUPS)
-- =================================================================
task.spawn(function()
    while true do
        task.wait(0.5)
        if _G.AutoUpgradeActive then
            pcall(function()
                -- Pure Server Remote Dispatcher (Zero GUI Interference / Zero Popups / Zero Input Locking)
                fireGameRemotes(
                    {
...
-- =================================================================
-- 3. AUTO COLLECT LOOP (MEDALS, COINS, SHARDS, GOLD BARS & DROPS)
-- =================================================================
task.spawn(function()
    while true do
        task.wait(0.3)
        if _G.AutoCollectActive then
            pcall(function()
                ...
                -- 1. Universal TouchTransmitter Collection
                ...
                -- 2. Collect Drops / Gold Bars / Medals / Shards by Name & Color
